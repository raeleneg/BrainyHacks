...
public class MainActivity extends Activity implements OnClickListener {
    ...
    public void receiveMuseDataPacket(final MuseDataPacket p, final Muse muse) {
        ...
        if (!averageSet) {
            ...
            TextView eegStatus = (TextView) findViewById(R.id.yourstatus);
            String eegMean = String.format("%6.2f", record.getMeanEeg1());
            if (record.isAbnormal()) {
                eegStatus.setText(eegMean + "Abnormal. Wait for help.");
            } else {
                eegStatus.setText(eegMean + "Normal. :)");
            }
        }
    }
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.choosemuse.example.libmuse/http/host/path")
        );
